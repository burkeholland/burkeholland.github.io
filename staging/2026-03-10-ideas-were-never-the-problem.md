...
I have a friend. He's a firefighter. Every time we get together, he has a new app idea. Every coffee, every happy hour, every time we end up standing in a parking lot way too long because neither of us wants to be the one to leave. He leans in and says "okay, I've been thinking about this thing" and off we go.

I'm embarrassed to admit this, but I used to dismiss most of them. Not out loud. I'd nod and ask questions and say "yeah, that's interesting." But in my head I was doing the math: how long would that take, how complicated is the backend, who would actually use this. And I'd land in the same place every time: not worth it.

The thing is, I don't actually know if those ideas were good or not. Because none of them ever got built. They just stayed in his head. He's a firefighter. He doesn't write code. So the ideas live and die in parking lot conversations. Developers have been the ones who decide what gets built, not because we're the smartest people in the room, but because we're the only ones who know how to build it. That's changing.
...
Sometimes I worry [we used to build cathedrals and now we're building strip malls](/posts/nothing-worth-remembering/). Accessible tools have a way of producing a lot of output that looks like the thing without being the thing.
...
Here's what I've been sitting with: this is actually a great moment to be a developer.
...
The flood of ideas my friend used to bring me, the ones I was quietly dismissing, a lot of those are going to get built now. Not all of them are good. Probably most of them aren't. But some of them are. Some of them would have been worth building years ago if anyone had found the time and the money and the right person to build them.
